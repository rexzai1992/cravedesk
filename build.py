...
def build_flutter_dmg(version, features):
    ...
    system2('cp -rf ../target/release/service ./build/macos/Build/Products/Release/CraveDesk.app/Contents/MacOS/')
    '''
    system2(
        "create-dmg --volname \"CraveDesk Installer\" --window-pos 200 120 --window-size 800 400 --icon-size 100 --app-drop-link 600 185 --icon CraveDesk.app 200 190 --hide-extension CraveDesk.app cravedesk.dmg ./build/macos/Build/Products/Release/CraveDesk.app")
    os.rename("cravedesk.dmg", f"../cravedesk-{version}.dmg")
    '''
    os.chdir("..")
